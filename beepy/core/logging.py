# $Id: logging.py,v 1.4 2003/01/30 09:24:29 jpwarren Exp $
# $Revision: 1.4 $
#
...
class Log:
    ...
    def logmsg(self, msglevel=constants.DEFAULT_LOGMSG_LEVEL, *msgs ):
        if self.loglevel == -1:
            return
    ...
    def traceback(self):
        """ Print out a stack trace at level DEBUG """
