# $Id: test_parser.py,v 1.9 2008/05/10 03:04:12 jpwarren Exp $
# $Revision: 1.9 $
#
...
# RFC 3080 Section 2.3.1.1
	def test_2311001_parseGreeting(self):
		...
		file = open( sibpath(__file__, 'beep_greeting.xml') )
	...
	def test_2311002_parseGreetingSingleProfile(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_greeting_with_single_profile.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'greeting' )
	...
	def test_2311003_parseGreetingMultipleProfile(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_greeting_with_multiple_profiles.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'greeting' )
	...
	def test_2311004_parseGreetingSingleFeature(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_greeting_with_single_feature.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'greeting' )
	...
	def test_2311005_parseGreetingMultipleFeature(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_greeting_with_multiple_feature.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'greeting' )
	...
	def test_2311006_parseGreetingSingleLocalize(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_greeting_with_single_localize.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'greeting' )
	...
	def test_2311007_parseGreetingMultipleLocalize(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_greeting_with_multiple_localize.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'greeting' )
	...
	def test_2311008_parseGreetingSingleFeatureLocalize(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_greeting_single_feature_localize.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'greeting' )
	...
	def test_2311009_parseGreetingMultipleFeatureLocalize(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_greeting_multiple_feature_localize.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'greeting' )
	...
	def test_2311010_parseGreetingMultipleEverything(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_greeting_multiple_everything.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'greeting' )
...
# Section 2.3.1.2
	def test_2312001_parseStartSingleProfile(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_start_with_single_profile.xml'))
		message = parser.parse(file)
	...
	def test_2312002_parseStartNoProfile(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_start_no_profile.xml'))
	...
	def test_2312003_parseStartNegativeChannelNumber(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_start_negative_number.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'start' )
	...
	def test_2312004_parseStartTooLargeChannelNumber(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_start_toolarge_number.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'start' )
	...
	def test_2312005_parseStartAlphaNumber(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_start_alpha_number.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'start' )
	...
	def test_2312006_parseStartOddNumber(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_start_odd_number.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'start' )
	...
	def test_2312007_parseStartEvenNumber(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_start_even_number.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'start' )
	...
	def test_2312008_parseStartMultipleProfile(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_start_with_multiple_profile.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'start' )
	...
	def test_2312009_parseStartReadyCDATA(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_start_with_ready_cdata.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'start' )
	...
	def test_2312010_parseStartProceedCDATA(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_start_with_proceed_cdata.xml'))
		message = parser.parse(file)
	...
	def test_2312011_parseStartBlobCDATA(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_start_with_blob_cdata.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'start' )
	...
	def test_2312012_parseStartBlobAndEncoding(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_start_with_blob_encoding.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'start' )
	...
	def test_2312013_parseStartNoBlobAndEncoding(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_start_with_encoding_noblob.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'start' )
	...
	def test_2312014_parseStartProfileContentsTooLarge(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_start_with_profile_contents_toolarge.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'start' )
	...
	def test_2312015_parseStartServername(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_start_with_servername.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'start' )
...
# Section 2.3.1.3
	def test_2313001_parseClose(self):
		"""Parse close"""
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_close.xml'))
		message = parser.parse(file)
	...
	def test_2313002_parseCloseWithNegativeNumber(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_close_negative_number.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'close' )
	...
	def test_2313003_parseCloseWithTooLargeNumber(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_close_toolarge_number.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'close' )
	...
	def test_2313004_parseCloseWithAlphaNumber(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_close_alpha_number.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'close' )
	...
	def test_2313005_parseCloseWithNoNumber(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_close_no_number.xml'))
		self.assertRaises( mgmtparser.ParserException, parser.parse, file )

	def test_2313006_parseCloseWithAlphaCode(self):
		"""Parse close with alpha code"""
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_close_alpha_code.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'close' )
	...
	def test_2313006_parseCloseWithNoCode(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_close_no_code.xml'))
		self.assertRaises( mgmtparser.ParserException, parser.parse, file )

	def test_2313007_parseCloseWithXMLLang(self):
		"""Parse close with xml:lang"""
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_close_xmllang.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'close' )
	...
	def test_2313008_parseCloseWithXMLLangNoText(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_close_xmllang_no_text.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'close' )
...
# Section 2.3.1.4
	def test_2314001_parseOK(self):
		"""Parse ok"""
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_ok.xml'))
		message = parser.parse(file)
	...
	def test_2314002_parseOKWithAttrs(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_ok_with_attrs.xml'))
		self.assertRaises( mgmtparser.ParserException, parser.parse, file )

	def test_2314003_parseOKWithChildren(self):
		"""Parse ok with children (malformed)"""
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_ok_with_children.xml'))
		self.assertRaises( mgmtparser.ParserException, parser.parse, file )
...
# Section 2.3.1.5
	...
	def test_2315001_parseError(self):
		"""Parse error"""
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_error.xml'))
		message = parser.parse(file)
	...
	def test_2315002_parseErrorWithText(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_error_with_text.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'error' )
	...
	def test_2315003_parseErrorWithInvalidCode(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_error_with_invalid_code.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'error' )
	...
	def test_2315004_parseErrorWithXMLLang(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_error_with_xmllang.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'error' )
	...
	def test_2315004_parseErrorWithXMLLangNoText(self):
		...
		parser = mgmtparser.Parser()
		file = open( sibpath(__file__, 'beep_error_with_xmllang_notext.xml'))
		message = parser.parse(file)
		self.assertEqual( message.type, 'error' )
